...
public class NoticeAdapter extends RecyclerView.Adapter<NoticeAdapter.MyViewHolder> {
    ...
    public NoticeAdapter(Context context, ArrayList<Notice> notices, NoticeActivity noticeActivity) {
    ...
    public void onBindViewHolder(@NonNull NoticeAdapter.MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> noticeActivity.handleNoticeClick(notice, position));
    }
